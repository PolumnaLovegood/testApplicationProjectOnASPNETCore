...
namespace WebApplicationStudentd.Controllers
{
    public class StudentsController : Controller
    {
        ...
        public StudentsController(WebApplicationStudentdContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Students != null ? 
                          ...
                          Problem("Entity set 'WebApplicationStudentdContext.Students'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'WebApplicationStudentdContext.Students'  is null.");
            }
            var students = await _context.Students.FindAsync(id);
            if (students != null)
            {
        ...
        public IActionResult StudentIdUnique(int id)
        {
            if (_context.Students == null)
            {
                return Problem("Entity set 'StudentCourseContext.Courses'  is null.");
            }
            if (_context.Students.Any(x => x.StudentId == id))
            {
                return Json($"Student with this ID is already exist.");
            }
            return Json(true);
        }
    }
